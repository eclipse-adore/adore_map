 ...
 * @note This class e(x)tends the fixed_sized_(cache) to provide a custom cache implementation
...
public:
   ...
   */
  explicit XCache( size_t max_size, const Policy<Key> policy = Policy<Key>{},
